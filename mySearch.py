...
class BeamSearch(object):
    ...
    def _compile_initial_state_and_context_computer(self):
        ...
        # print("self.inputs_beforeError" , self.inputs)
        # print("outputs_beforeError", outputs)
        # print("self.inputs_shape", self.inputs[0].shape , " " , self.inputs[1].shape)
        self.initial_state_and_context_computer = function(
            self.inputs, outputs, on_unused_input='warn')
        # print(3)
    ...
    def compute_initial_states_and_contexts(self, inputs):
        ...
        # print("self.inputs_mySearch" , self.inputs)
        # print("inputs_mysearch" , inputs)
        # input_0 = [self.inputs[0]]
        # print("self.inputs ",inputs[self.inputs[0]].shape," " ,inputs[self.inputs[1]].shape)
        # print("before inja")
